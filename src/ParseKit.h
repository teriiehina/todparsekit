...
/*!
    @mainpage   PKParseKit
                PKParseKit is a Mac OS X Framework written by Todd Ditchendorf in Objective-C 2.0 and released under the MIT Open Source License.
                ...
                Classes in the PKParseKit Framework offer 2 basic services of general use to Cocoa developers:
