...
/*!
    ...
    @details    <tt>start</tt> and <tt>end</tt> may be different strings. e.g. <tt>/*</tt> and <tt>*\/</tt>. Also, the actual comment may or may not be multi-line.
...
/*!
    @brief      Removes <tt>start</tt> and it's orignall <tt>end</tt> counterpart as a multi-line comment start and end markers.
