...
#import "TODNumberStateTest.h"


@implementation TODNumberStateTest

- (void)setUp {
	numberState = [[TODNumberState alloc] init];
}
...
- (void)testSingleDigit {
	...
	TODToken *t = [numberState nextTokenFromReader:r startingWith:[r read] tokenizer:nil];
