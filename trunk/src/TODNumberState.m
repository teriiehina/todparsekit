...
- (void)parseLeftSideFromReader:(TODReader *)r;
- (void)parseRightSideFromReader:(TODReader *)r;
- (void)reset:(NSInteger)cin;
@end


@implementation TODNumberState
...
- (TODToken *)nextTokenFromReader:(TODReader *)r startingWith:(NSInteger)cin tokenizer:(TODTokenizer *)t {
	...
	return [[[TODToken alloc] initWithTokenType:TODTT_NUMBER 
