...
- (void)testOneHundredDivZero {
    s = @"100 / 0";
    result = [p parse:s];
    TDEquals((CGFloat)INFINITY, result);
}
...
- (void)test100minus25times3 { // precedence
    s = @"100 - 25*3";
    result = [p parse:s];
    STAssertEqualsWithAccuracy((CGFloat)25.0, result, 1.0, @"");
}
